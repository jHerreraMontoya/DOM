...
function initPopulate() {
    ...
    //OBJETOS RESOURCE
    try {
        var resource1 = new Resource(120, "https://www.jenflix.es");
        var resource2 = new Resource(40, "https://www.jenflix.es");
        var resource3 = new Resource(210, "https://www.jenflix.es");
        var resource4 = new Resource(80, "https://www.jenflix.es");
    } catch (err) {
        console.log(err.toString());
    }
...
function showActor() {
    ...
    while (actor.done !== true) {
        ...
        if (nomApe === this.value) { //Si el nombre del actor nos coincide con el valor del boton de dicho Actor muestra su información
            ...
            //Iteramos sobre las producciones pertenecientes a ese actor
...
function showDirector() {
    ...
    while (director.done !== true) {
        ...
        if (nomApe === this.value) {
            ...
            //Iteramos sobre las producciones pertenecientes a ese director
